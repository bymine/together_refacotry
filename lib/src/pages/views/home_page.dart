        ...
        children: [
          Expanded(
            ...
            child: Swiper(
              ...
              itemCount: controller.fixProject.length,
              loop: false,
              scale: 0.8,
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        opacity: 0.8,
                        image:
                            Image.asset(controller.fixProject[index].imageUrl)
                                .image,
                        fit: BoxFit.fill),
                  ),
                  child: Column(
                    ...
                    children: [
                      Text(controller.fixProject[index].title),
                      Text(controller.fixProject[index].notes)
                    ],
                  ),
                );
              },
