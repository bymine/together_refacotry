...
import 'package:together_refacotry/src/pages/views/chat_view.dart';
import 'package:together_refacotry/src/pages/views/file_view.dart';
import 'package:together_refacotry/src/pages/views/home_page.dart';
import 'package:together_refacotry/src/pages/views/schdule_page.dart';
import 'package:together_refacotry/src/pages/views/setting_view.dart';
